...
import { StudentCouncilContent } from "./student-council-content";
  ...
  return (
    <div className="space-y-6 animate-fade-in-up opacity-0" style={{ animationDelay: "100ms" }}>
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Student Council</h1>
          <p className="text-muted-foreground mt-2">
            Leadership positions and student representatives in hierarchical order
          </p>
        </div>
        {hasEditPermission && (
          <Link href="/dashboard/school-council/student-council/edit">
