...
export function PromotionManager({
    ...
    async function handlePromotion() {
        ...
        try {
            ...
            toast.success(`Successfully promoted ${selectedStudentIds.size} students`)
            router.refresh()
        ...
        <div className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card className={step === 1 ? 'border-primary' : ''}>
                    <CardHeader>
                        ...
                        <CardDescription>Where are the students coming from?</CardDescription>
                    </CardHeader>
            ...
            {step === 1 && (
                <div className="flex justify-end gap-2">
                    ...
                    <Button onClick={fetchStudents} disabled={loading || !sourceYearId || !sourceClassId}>
            ...
            {step === 2 && (
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-3">
                            {students.map(student => (
                                <div key={student.id} className="flex items-center space-x-2 p-2 border rounded hover:bg-muted/50">
                                    <Checkbox
                                        id={student.id}
                    ...
                    <div className="p-6 border-t bg-muted/20 flex justify-between">
                        ...
                        <Button onClick={handlePromotion} disabled={promoting || selectedStudentIds.size === 0}>
                            {promoting ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <ArrowRight className="mr-2 h-4 w-4" />}
