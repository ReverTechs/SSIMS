...
import { parseStudentFile } from '@/lib/utils/csv-parser';
import { downloadCSVTemplate, downloadExcelTemplate } from '@/lib/utils/bulk-upload-helpers';
import type { ParsedFileData } from '@/types/bulk-upload-types';
...
export function BulkUploadDropzone({ onFilesParsed, onError }: BulkUploadDropzoneProps) {
    ...
    const onDrop = useCallback(async (acceptedFiles: File[]) => {
        ...
        try {
            ...
            // Parse the file
            const parsedData = await parseStudentFile(file);
        ...
        <div className="space-y-4">
            ...
            <Alert>
                ...
                <AlertDescription className="text-sm">
                    <strong>Important:</strong> All students will receive the default password{' '}
